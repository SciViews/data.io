...
- Uppercase for factor levels,

- data frames are `c("data_frame", "tbl_df", "tbl", "data.frame")`. Thus, their are also **tibble**s, and an additional `data_frame` class, that can be used for custom methods like `summary()` (not used yet).
