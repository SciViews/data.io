...
- data frames are `c("dataframe", "tbl_df", "tbl", "data.frame")`. Thus, their are also **tibble**s, and an additional `dataframe` class, that can be used for custom methods like `summary()` (not used yet).
